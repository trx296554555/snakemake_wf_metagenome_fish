...
checkpoint refine_bins_DAS_tool:
    input:
        ...
        metabat2_bins=get_metabat2_names,
        concoct_bins=get_concoct_names,
        maxbin2_bins=get_maxbins_names,
    output:
